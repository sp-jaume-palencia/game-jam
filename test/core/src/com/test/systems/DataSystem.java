...
public class DataSystem
{
	...
	public void load()
	{
		...
		map.addBase(2, new BaseData(2, 0, new Vector2(730, 380), new int[] { 1,4,9 }));
		map.addBase(3, new BaseData(3, 0, new Vector2(323, 681), new int[] { 1,4,5 }));
		map.addBase(4, new BaseData(4, 0, new Vector2(719, 684), new int[] { 2,3,5,8,9 }));
		map.addBase(5, new BaseData(5, 0, new Vector2(482, 984), new int[] { 3,4,6 }));
		...
		map.addBase(9, new BaseData(9, 0, new Vector2(1064, 507), new int[] { 2,4,8,10,12 }));
		map.addBase(10, new BaseData(10, 0, new Vector2(1300, 363), new int[] { 9,11,31 }));
		map.addBase(11, new BaseData(11, 0, new Vector2(1513, 819), new int[] { 10,12,30,31 }));
		...
		map.addBase(27, new BaseData(27, 0, new Vector2(1744, 2592), new int[] { 25,26,37 }));
		map.addBase(28, new BaseData(28, 0, new Vector2(1729, 1686), new int[] { 26,29,34,40,36,37 }));
		map.addBase(29, new BaseData(29, 0, new Vector2(1496, 1470), new int[] { 12,17,28,30 }));
		map.addBase(30, new BaseData(30, 0, new Vector2(1753, 1248), new int[] { 11,32,33,35,34,29 }));
		map.addBase(31, new BaseData(31, 0, new Vector2(1759, 348), new int[] { 10,11,32 }));
		map.addBase(32, new BaseData(32, 0, new Vector2(1987, 495), new int[] { 31,30,33,39,38 }));
		map.addBase(33, new BaseData(33, 0, new Vector2(2038, 915), new int[] { 30,32,35,39 }));
		...
		map.addBase(37, new BaseData(37, 0, new Vector2(1981, 2442), new int[] { 27,28,36,41,42 }));
		map.addBase(38, new BaseData(38, 0, new Vector2(2326, 348), new int[] { 32,39,43 }));
		map.addBase(39, new BaseData(39, 0, new Vector2(2329, 660), new int[] { 33,32,38,44,45 }));
		map.addBase(40, new BaseData(40, 0, new Vector2(2221, 1680), new int[] { 36,28,34,51,47 }));
		map.addBase(41, new BaseData(41, 0, new Vector2(2335, 2271), new int[] { 36,37,42,49,48 }));
		map.addBase(42, new BaseData(42, 0, new Vector2(2326, 2592), new int[] { 37,41,50 }));
		map.addBase(43, new BaseData(43, 3, new Vector2(2728, 351), new int[] { 38,44 }));
		map.addBase(44, new BaseData(44, 0, new Vector2(2728, 660), new int[] { 43,39,45 }));
		map.addBase(45, new BaseData(45, 0, new Vector2(2566, 975), new int[] { 39,44,46 }));
		map.addBase(46, new BaseData(46, 0, new Vector2(2719, 1287), new int[] { 45,35,51 }));
		map.addBase(47, new BaseData(47, 0, new Vector2(2722, 1644), new int[] { 48,40,51 }));
		...
		map.addBase(51, new BaseData(51, 0, new Vector2(2449, 1470), new int[] { 35,46,40,47 }));
	}
